...
* Technology used: Google Colab, Python 3.1.2, Pandas, Numpy, Scikit-learn, Matplotlib, Seaborn, Yellowbrick, PCA, Agglomerative Clustering, Label Encoding, StandardScaler, Google Colab, Jupyter Notebook
